...
.hot-ranking-swiper {
  ...
  overflow: hidden;
  box-shadow:
      0 12rpx 48rpx rgba(251, 0, 85, 0.08),
      0 4rpx 20rpx rgba(0, 0, 0, 0.04),
      0 1rpx 4rpx rgba(0, 0, 0, 0.02);
  position: relative;
  border: 1rpx solid rgba(251, 0, 85, 0.06);
...
.ranking-header {
  ...
  &::after {
    ...
    right: 32rpx;
    height: 1rpx;
    background: linear-gradient(90deg, transparent, rgba(251, 0, 85, 0.1), transparent);
  }
  ...
  .header-left {
    ...
    .header-icon {
      ...
      height: 36rpx;
      margin-right: 20rpx;
      filter: drop-shadow(0 2rpx 8rpx rgba(251, 0, 85, 0.3));
    ...
    .header-title {
      ...
      background: linear-gradient(135deg, #1a1a1a 0%, #fb0055 100%);
  ...
  .header-right {
    ...
    .refresh-btn {
      ...
      padding: 16rpx;
      border-radius: 50%;
      background: linear-gradient(135deg, #fb0055 0%, #ff6b9d 100%);
      color: white;
      transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
      backdrop-filter: blur(10rpx);
      border: 1rpx solid rgba(255, 255, 255, 0.2);
      box-shadow:
          0 4rpx 16rpx rgba(251, 0, 85, 0.3),
          0 2rpx 8rpx rgba(0, 0, 0, 0.1);

      &:active {
        transform: rotate(360deg) scale(0.95);
        background: linear-gradient(135deg, #e00050 0%, #ff5a91 100%);
        box-shadow:
            0 2rpx 12rpx rgba(251, 0, 85, 0.4),
...
.ranking-item {
  ...
  &::before {
    ...
    right: 0;
    bottom: 0;
    background: linear-gradient(135deg, transparent 0%, rgba(251, 0, 85, 0.01) 100%);
    opacity: 0;
  ...
  &.top-item {
    background: linear-gradient(135deg, #ffffff 0%, rgba(251, 0, 85, 0.02) 100%);
    border: 1rpx solid rgba(251, 0, 85, 0.08);
    box-shadow:
        0 4rpx 16rpx rgba(251, 0, 85, 0.08),
    ...
    &::after {
      ...
      bottom: 0;
      width: 4rpx;
      //background: linear-gradient(to bottom, #fb0055, #ff6b9d);
  ...
  &:active {
    ...
    box-shadow:
        0 2rpx 12rpx rgba(251, 0, 85, 0.12),
...
.rank-badge {
  ...
  .rank-number {
    ...
    color: #fb0055;
    background: linear-gradient(135deg, #fb0055 0%, #ff6b9d 50%, #fb0055 100%);
    background-clip: text;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    text-shadow:
        2rpx 2rpx 4rpx rgba(251, 0, 85, 0.3),
        0 0 8rpx rgba(251, 0, 85, 0.2);
    filter: drop-shadow(0 2rpx 4rpx rgba(251, 0, 85, 0.2));
    ...
    &::before {
      ...
      width: 120%;
      height: 120%;
      background: linear-gradient(45deg, rgba(251, 0, 85, 0.1), transparent);
      border-radius: 8rpx;
      z-index: -1;
      opacity: 0;
      transition: opacity 0.3s ease;
    ...
    &:active {
      ...
      filter: drop-shadow(0 1rpx 2rpx rgba(251, 0, 85, 0.4));
...
.hot-score {
  display: flex;
  align-items: center;
  background: linear-gradient(135deg, rgba(251, 0, 85, 0.1) 0%, rgba(255, 107, 157, 0.08) 100%);
  padding: 6rpx 12rpx;
  border-radius: 16rpx;
  border: 1rpx solid rgba(251, 0, 85, 0.15);
  flex-shrink: 0;
  box-shadow: 0 2rpx 8rpx rgba(251, 0, 85, 0.08);
  transition: all 0.3s ease;

  &:hover {
    transform: translateY(-1rpx);
    box-shadow: 0 4rpx 12rpx rgba(251, 0, 85, 0.15);
  }
  ...
  .score-icon {
    ...
    height: 20rpx;
    margin-right: 4rpx;
    filter: drop-shadow(0 1rpx 2rpx rgba(251, 0, 85, 0.3));
  }
...
@keyframes glow {
  ...
  100% {
    ...
    filter: drop-shadow(0 4rpx 12rpx rgba(251, 0, 85, 0.5));
  }
}
